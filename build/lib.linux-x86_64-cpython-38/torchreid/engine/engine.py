...
class Engine(object):
    ...
    def __init__(self, datamanager, model, G, optimizer_m=None, optimizer_G=None, scheduler_m=None, scheduler_G=None,use_gpu=True):
    ...
    def run(self, save_dir='log', max_epoch=0, start_epoch=0, fixbase_epoch=0, open_layers=None,
        ...
        for epoch in range(start_epoch, max_epoch):
            ...
            if (epoch+1) % 10 == 0:
                ...
                self._save_checkpointG(epoch, rank1, save_dir)
    ...
    def _save_checkpointG(self, epoch, rank1, save_dir, is_best=False):
        save_checkpoint_G({
